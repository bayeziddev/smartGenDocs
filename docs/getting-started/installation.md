...
*   **Python 3.8+**: SmartGen Docs requires Python 3.8 or a newer version. You can download Python from the [official Python website](https://www.python.org/downloads/).
...
If you encounter any issues during installation, please refer to the [Troubleshooting Guide](../guides/troubleshooting.md) or check the [FAQ](faq.md) for common problems and solutions. If your issue persists, consider reporting it on our [GitHub Issues](https://github.com/bayeziddev/smartGenDocs/issues) page.
